...
//236909/264627/2.49/29/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "QFN50P500X500X100-29N" (originalName "QFN50P500X500X100-29N")
		...
		(layerContents (layerNumRef 18)
			(arc (pt -2.9, 2.25) (radius 0) (width 0.25))
		)
	)
	(symbolDef "CP2102-GM" (originalName "CP2102-GM")
	...
	(compDef "CP2102-GM" (originalName "CP2102-GM") (compHeader (numPins 29) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "29" (pinName "GND_2") (partNum 1) (symPinNum 22) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CP2102-GM"))
		...
		(attr "Manufacturer_Part_Number" "CP2102-GM")
		(attr "Mouser Part Number" "634-CP2102-GM")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Silicon-Labs/CP2102-GM?qs=yHCtFi5ROqJvCcyR88R4Pg%3D%3D")
		(attr "Arrow Part Number" "CP2102-GM")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/cp2102-gm/silicon-labs?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "CP2102-GM, USB Controller 12Mbit/s USB 2.0, 3.3 V, 28-Pin, QFN")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets_SAMA/e8061a629457dcd57bb8c8d46a00fbc0.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "CP2102-GM.stp")
