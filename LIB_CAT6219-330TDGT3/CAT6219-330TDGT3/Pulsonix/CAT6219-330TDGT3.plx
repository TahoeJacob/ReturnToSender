...
(library Library_1
	...
	(compDef "CAT6219-330TDGT3" (originalName "CAT6219-330TDGT3") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "BYP/ADJ") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "Description" "")
		(attr "<Hyperlink>" "http://www.onsemi.com/pub/Collateral/CAT6219-D.PDF")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "CAT6219-330TDGT3.stp")
